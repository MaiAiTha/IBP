...
function networkUp() {
  docker-compose -f ${SRC_DIR}/../ibp-usecase-1/console-org1/docker-org1/docker-compose-console.yaml up -d
	docker-compose -f ${SRC_DIR}/../ibp-usecase-1/console-org1/docker-org1/docker-compose-grpc-web.yaml up -d
...
function networkDown() {
  docker-compose -f ${SRC_DIR}/../ibp-usecase-1/console-org1/docker-org1/docker-compose-console.yaml down
	docker-compose -f ${SRC_DIR}/../ibp-usecase-1/console-org1/docker-org1/docker-compose-grpc-web.yaml down
